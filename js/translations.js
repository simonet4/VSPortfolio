...
// Contient: Français (fr), Anglais (en), Portugais (pt)
...
translations = {
    fr: {
        ...
        about: {
            ...
            quote: "Plus un ordinateur possède de RAM, plus vite il peut générer un message d'erreur.", // Citation Dave Barry
            ...
            step3_desc: "Apprentissage autodidacte C / Arduino et Web."
        },
        projects: {
    ...
    en: {
        ...
        about: {
            ...
            quote: "The more memory a computer has, the faster it can generate an error message.",
            timeline_title: "Timeline",
            step1_title: "Computer Science Degree (Toulouse)",
            ...
            step3_desc: "Self-taught learning of C, Arduino and Web."
        },
        projects: {
    ...
    pt: {
        ...
        about: {
            ...
            quote: "Quanto mais memória um computador tem, mais rápido ele pode gerar uma mensagem de erro.",
            timeline_title: "Trajetória",
            step1_title: "Graduação em Informática (Toulouse)",
            ...
            step3_desc: "Aprendizado autodidata de C, Arduino e Web."
        },
        projects: {
